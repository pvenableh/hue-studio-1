...
defineOgImage({ component: 'HueOg', props: { title: 'Hue Creative Marketing', description: 'Brand strategy, digital experience, and creative execution for growth-stage companies.' } })
