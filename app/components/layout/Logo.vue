<template>
  ...
  >
    <path
      class="h letter letter-1"
      :class="{ 'blur-path': props.blur }"
...
.logo-animate .letter-1 { animation-delay: 0.1s; }
.logo-animate .letter-2 { animation-delay: 0.25s; }
.logo-animate .letter-3 { animation-delay: 0.4s; }
